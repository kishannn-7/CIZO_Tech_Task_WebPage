...
const AboutUs = () => {
    ...
    return (
        <section id="about" className="bg-white py-14 mx-4 sm:mx-15 lg:mx-30">
            <div className="flex flex-wrap md:grid md:grid-cols-2 gap-10 items-center">
                {/* Text Content */}
                <div className="top-0 h-fit flex flex-col items-start self-start justify-center">
                ...
                {/* Video Section */}
                <div className="relative rounded-2xl overflow-hidden shadow-lg w-full aspect-video h-64 sm:h-80 md:h-96">
                    <video
                        ref={videoRef}
